...
/**
 * Renders its children only when Photos runs **standalone**. Inside the Mind
 * shell (brokered mode) it renders nothing — the shell already provides the
 * chrome (app title, navigation, app launcher, theme), so Photos' own masthead
 * would be redundant duplicate chrome inside the shell's app body.
 *
 ...
 * overlay (it clears on `mind:ready`, which Photos fires only after this resolves).
 */
